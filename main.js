window.addEventListener("load", function(){
   preloader = document.querySelector(".preloader").classList.add("opacity-0");
   setTimeout(function(){
...
function validateForm() {
    ...
    submitted=true;
    var thankyou='Kami dapat mesej anda, terima kasih dari kami Kursus Asas Resume';
